Config = {
	...
	roleList = {
		{'Civilian', "^6👻Civilian👻^2 | "}, -- 1
		{'Server Booster', "^6👻Server Booster👻^2 | "}, -- 2
		{'Developer', "^6👻Developer👻^2 | "}, -- 3
		{'Customer', "^6👻Customer👻^2 | "}, -- 4
		{'Supporter',"^6👻Supporter👻^2 | "}, -- 5
		{'Staff', "^6👻Staff👻^2 | "}, -- 6
		{'Admin', "^6👻Admin👻^2 | "}, -- 7
		{'Founder/Owner👑', "^6👻Founder/Owner👑👻^2 | "}, -- 8
		{'Co/Owner👑', "^6👻Co/Owner👑👻^2 | "}, -- 8
	},
	allowedColors = {2, 3,9,8},
	allowedRed = {4, 5, 6, 7,1},
	allowedEmoji = {3, 7,},
