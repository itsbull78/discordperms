...
Citizen.CreateThread(function()
	...
	print("Join Universe Life RolePlay Discord To Get Your Jobs https://discord.gg/zDZRTAa6ag");
	print('Subscribe To ITSBULL78 Youtube Channel https://www.youtube.com/c/ITSBULL78');
end)
...
AddEventHandler('Badger_Discord_API:PlayerLoaded', function()
	...
	if (tracked[license] == nil) then 
		...
		'^1[^5Join^1] ^3Universe Life RolePlay Discord To Get Your Jobs ^6https://discord.gg/zDZRTAa6ag')
	end
	TriggerClientEvent('chatMessage', source, 
		'^7[^2Subscribe^7] ^3To ^5ITSBULL78 ^3Youtube ^3Channel ^5https://www.youtube.com/c/ITSBULL78 ^3Like/Subscribe/Notifications/On');
end)
